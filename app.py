...
col1.metric("Mediana wynagrodzenia", f"{selected_row['Mediana']:.0f} PLN")
col2.metric("Średnie wynagrodzenie", f"{selected_row['Średnia']:.0f} PLN")
col3.metric("Różnica (Średnia − Mediana)", f"{(selected_row['Średnia'] - selected_row['Mediana']):.0f} PLN")
